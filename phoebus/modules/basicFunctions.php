...
// This file contains a bunch of basic little functions that allow the
// application to work and also take up some of the burdon of redundent PHP
// code

// Specific intensive functions should go into their own PHP file and
// be added to the $arrayModules array.
