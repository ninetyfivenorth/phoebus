...
//                           : Matt A. Tobin -Compat with PHP 7- (email@mattatobin.com)
...
// Temporary Polyfill for REMOVED function (PHP 7)
function ereg($_regex, $_string) {
    return preg_match('/' . $_regex . '/', $_string);
}
